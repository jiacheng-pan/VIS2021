...
\textbf{2) visual encodings} by extracting visual mappings among data entities, attributes, and visual channels; and
\textbf{3) layout intention} by identifying different kinds of layouts and their impact factors.
...
We bind the highlight interaction to the descriptions to enhance the comprehension of audiences.
