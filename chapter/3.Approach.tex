...
\begin{table}[ht]
\caption{\label{tab:pearson-correlation}Pearson correlation coefficients that test whether the euclidean distance between two nodes is related to their graph geodesic distance. 15 graphs and 6 different layouts are employed.}
